...
namespace Konyvtar
{
    public partial class felvetel : Form
    {
        ...
        private void felvetel_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string szerzo = tb_konyvszerzo.Text;
            string kiado = tb_konyvkiado.Text;
            string megj = tb_konyvmegj.Text;
            string mufaj = tb_konyvmufaj.Text;

            Program.sql.CommandText = "INSERT INTO konyv (cim, szerzo, kiado, megj, mufaj) " +
                "VALUES  ('" + cim + "', '" + szerzo + "', '" + kiado + "', '" + megj + "', '" + mufaj + "');";
